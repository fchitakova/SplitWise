...
public class CommandParser {
    ...
    public static boolean matchPayedCommand(String command) {
        ...
        boolean commandMatchesPayedCommand = startsWith(command, PAYED_COMMAND) &&
                hasMinimumNumberOfArguments(commandArguments, MINIMUM_COUNT_OF_PAYED_COMMAND_ARGUMENTS);
        boolean commandMatchesPayedInGroupCommand = startsWith(command, PAYED_IN_GROUP_COMMAND) &&
                hasMinimumNumberOfArguments(commandArguments, MINIMUM_COUNT_OF_PAYED_IN_GROUP_COMMAND_ARGUMENTS);
    ...
    public static boolean matchCreateGroupCommandFormat(String command) {
        String[] commandArguments = getArguments(command);
        boolean doesInputMatchCommand = hasMinimumNumberOfArguments(commandArguments, MINIMUM_COUNT_OF_CREATE_GROUP_COMMAND_ARGUMENTS) &&
