...
public class User implements Serializable {
  public static final String NOT_ANY_OUTSTANDING_FINANCES =
      "You do not have any outstanding finances with friends.";
  ...
  public String getSplittingStatus() {
    String status =
        buildFriendsStatusMessage(friendships) + buildGroupFriendshipsStatusMessage(groups);
    if (status.isBlank()) {
