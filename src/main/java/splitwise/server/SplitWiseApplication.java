...
public class SplitWiseApplication {
	...
	commandFactory = new CommandFactory(new AuthenticationService(userRepository, activeUsers), new FriendshipService(userRepository, activeUsers), new MoneySplitService(userRepository, activeUsers));
