...
public class AddFriendCommand extends Command {
  public static final String USER_NOT_FOUND =
      "%s is not found. Check friend's username and try again.";
  public static final String ESTABLISHED_FRIENDSHIP =
      "Friendship is established." + START_SPLITTING;
  public static final String ALREADY_FRIENDS = "You are already friends.";
  public static final String FRIENDSHIP_CANNOT_BE_ESTABLISHED =
      "Friendship cannot be established due to unexpected error. Try again later.";
  ...
  private boolean isFriendPresent() {
    return friendshipCreator.checkIfRegistered(friendUsername)
        && (!commandInvokerUsername.equals(friendUsername));
  }
