...
public class SplitCommand extends Command {
  ...
  public static final String SPLITTING_IN_GROUP_IS_ALLOWED_ONLY_FOR_MEMBERS =
      "You must be part of the group to be allowed to split with its members!";
  public static final String SPLITTING_IS_ALLOWED_ONLY_WITH_FRIENDS =
      "You can split only with friends. Ensure that friendship is established before starting splitting.";
  ...
  public static final String SPLITTING_RESULT =
      "Split %s LV between you and [%s].Reason: %s. " + SEE_STATUS;
  public static final String GROUP_SPLITTING_RESULT =
      "Split %s LV between you and [%s] group members. Reason: [%s]. " + SEE_STATUS;
  ...
  private String split() {
    try {
      String commandResult =
          isGroupSplit ? splitInGroupAndGetResult() : splitWithFriendAndGetResult();
