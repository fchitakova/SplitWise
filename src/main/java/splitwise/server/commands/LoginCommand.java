...
public class LoginCommand extends Command {
  ...
  public static final String NOTIFICATIONS_TITLE =
      RED_STAR_SYMBOL
          + RED_STAR_SYMBOL
          + RED_STAR_SYMBOL
          + " Notifications "
  ...
  public static final String ALREADY_LOGGED_IN =
      "Already logged in. Logout first to log in another account.";
  ...
  private String appendNotificationsToResponse(
      StringBuilder response, Deque<String> notificationMessages) {
