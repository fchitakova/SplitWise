...
public class CreateGroupCommand extends Command {
  public static final String NOT_ENOUGH_PARTICIPANTS =
      "Group friendship can be established with at least 3 participants.";
  public static final String NOT_REGISTERED_PARTICIPANTS = "All participants must be registered!";
  public static final String ALREADY_TAKEN_GROUP_NAME =
      "group name is already taken. Try with another name.";
  public static final String GROUP_CREATION_FAILED = "Group creation failed. Try again later.";
  public static final String SUCCESSFULLY_CREATE_GROUP =
      "Group friendship is successfully created." + START_SPLITTING;
    ...
    try {
      if (friendshipService.canGroupBeCreated(groupName, Arrays.asList(participants))) {
        friendshipService.createGroupFriendship(
            commandInvokerUsername, groupName, Arrays.asList(participants));
