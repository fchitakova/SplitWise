...
public class PayedCommand extends Command {
  ...
  public static final String SUCCESSFULLY_PAYED_RESULT =
      "Successfully updated friendship account between you and %s [%s]. " + SEE_STATUS;
  public static final String SUCCESSFULLY_PAYED_IN_GROUP_RESULT =
      "Successfully updated friendship account between you and %s in group:%s [%s]. " + SEE_STATUS;
  public static final String ALLOWED_ONLY_FOR_GROUP_MEMBERS =
      "You must be group member to accept group payments.";
  public static final String ALLOWED_ONLY_FOR_FRIENDS =
      "Accepting payments of non-friend is not allowed.";
  ...
  private String payed() {
    if (moneySplitService.areFriends(commandInvokerUsername, debtorUsername)) {
      try {
        ...
        String commandSuccessResult =
            String.format(SUCCESSFULLY_PAYED_RESULT, debtorUsername, splitReason);
        return commandSuccessResult;
      } catch (MoneySplitException e) {
        return COMMAND_FAILED;
      }
