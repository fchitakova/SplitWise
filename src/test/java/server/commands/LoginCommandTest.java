...
public class LoginCommandTest {
  ...
  public void testThatInvalidCredentialsMessageIsReturnedWhenInvalidCredentialsAreProvided() {
    ...
    when(authenticationService.checkCredentialsValidity(TEST_USERNAME1, TEST_PASSWORD1))
        .thenReturn(false);

    String assertMessage =
        "Login attempt with invalid credentials did not return right invalid credentials message.";
  ...
  public void testThatNoNotificationsMessageIsReturnedWhenThereAreNotAnyNotifications() {
    ...
    String assertMessage =
        "Not right login response is returned when there are not any notifications.";
