...
public class CommandFactoryTest {
  ...
  public static void setUp() {
    ...
    commandFactory =
        new CommandFactory(authenticationService, friendshipService, moneySplitService);
  }
  ...
  public void testThatSplitCommandWithNotValidAmountArgumentIsNotValid() {
    ...
    String assertMessage =
        "Parsing Split command with invalid money amount argument must return InvalidCommand.";
    Command command = commandFactory.getCommand(splitCommand);
