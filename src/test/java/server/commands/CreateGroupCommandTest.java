...
public class CreateGroupCommandTest {
  private static String CREATE_GROUP_COMMAND =
      "create-group myGroup " + TEST_USERNAME1 + " " + TEST_USERNAME2;
  ...
  @Test
  public void
      testThatCreateGroupCommandInvocationWithoutBeingLoggedInReturnsLoginOrRegisterResponse() {
    ...
    String assertMessage =
        "Group creation attempt without being logged in must return login or register response";
  ...
  public void testThatCreateGroupWithNotEnoughMembersReturnsNotAllowedResponse() {
    ...
    createGroupCommand =
        new CreateGroupCommand(createGroupCommandWith2Participants, friendshipService);

    String assertMessage =
        "Group creation with less than 3 members (creator included) is not allowed.";
    String commandResult = createGroupCommand.execute();
